...
public class ScrollPane extends WidgetGroup {
    ...
    public void layout () {
        ...
        widgetWidth = disableX ? widgetAreaBounds.width : Math.max(areaWidth, widgetWidth);
        widgetHeight = disableY ? widgetAreaBounds.height : Math.max(areaHeight, widgetHeight);
